...
def find_hyperplanes_reg(weights: list[Weight], V: Representation, u: int,exp_dim: int, sym:list[int]) -> Iterable[list[Weight]]:
    """
    ...
    return find_hyperplanes_reg_impl(St, V.G, u,exp_dim,sym)


def find_hyperplanes_reg_impl(St: WeightSieve, G: LinGroup, u: int,exp_dim: int, sym:list[int]) -> Iterable[list[Weight]]:
    """ 
